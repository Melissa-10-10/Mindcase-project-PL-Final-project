...
INSERT INTO PUBLIC_HOLIDAYS (HOLIDAY_DATE, HOLIDAY_NAME) VALUES (DATE '2025-12-31', 'New Years Eve Observed');
COMMIT;
```
![IMAGE](https://github.com/Melissa-10-10/Mindcase-project-PL-Final-project/blob/190867dfe2cfacd6a096d2c2b8ee58d6ea9cbf1f/CREATION%20holiday.PNG)
...
CREATE TABLE AUDIT_LOG_TBL (
    ...
    USER_ACTION       VARCHAR2(50) DEFAULT SYS_CONTEXT('USERENV', 'OS_USER') NOT NULL,
    USER_SCHEMA       VARCHAR2(50) DEFAULT SYS_CONTEXT('USERENV', 'SESSION_USER') NOT NULL,
    ACCESS_GRANTED    CHAR(1) NOT NULL,
...
![image](https://github.com/Melissa-10-10/Mindcase-project-PL-Final-project/blob/60b7a1315bac272556b7f1abce187e702979eb85/user%20info.PNG)
